...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "AI technology news Asia",
    "Future of AI workforce",
    "AI news India",
    "AI innovations Singapore",
    "AI news websites",
  ...
  openGraph: {
    ...
    description:
      "Discover the future of Artificial Intelligence. Daily updates on AI Business, Design, and Tech trends from India and Asia. Master GenAI tools and strategies today.",
